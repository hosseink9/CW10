...
with open("my_jason.json", "w") as outfile:
...
text_dictionary = jason_loader("my_jason.json")
...
with open("new_student.json", "w") as outfile:
    json.dump(new_student1_json, outfile)

loaded_student = jason_loader("new_student.json")
